...
namespace PickingListsSystem.DataAccess.Migrations
{
    ...
    [Migration("20240519151533_DeleteStatement_try2")]
    partial class DeleteStatement_try2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PickingListsSystem.Entities.Material", b =>
                {
                    b.HasOne("PickingListsSystem.Entities.Statement", "Statement")
                        .WithMany("Materials")
            ...
            modelBuilder.Entity("PickingListsSystem.Entities.Statement", b =>
                {
                    b.HasOne("PickingListsSystem.Entities.Project", "Project")
                        .WithMany("Statement")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PickingListsSystem.Entities.Work", "Work")
                        .WithMany()
                        .HasForeignKey("WorkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
